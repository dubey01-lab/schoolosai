...
// If we already modified it, let's restore the original from the file we replaced earlier
// Wait, I didn't save a backup. Let me rewrite the exact strict rules I wrote earlier.

const strictRules = `rules_version = '2';
...
fs.writeFileSync('firestore.rules', strictRules);
