    ...
    />
      ...
      <section className="py-24 px-6 lg:px-12 max-w-4xl mx-auto bg-white border-t border-slate-200">
        ...
        <div className="space-y-12">
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">What is SchoolOS AI?</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Who can use SchoolOS AI?</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Can teachers take attendance online?</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Can schools manage fees and receipts?</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Does SchoolOS AI support multiple schools?</h2>
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">How does SchoolOS AI protect school data?</h2>
